...
class MLM(nn.Module):
    ...
    def forward(self, seq, **kwargs):
        ...
        ## I think I need to add an embedding here that feeds into the next line of code
        # embedded_seq = self.embedding(masked_seq)
        # logits = self.transformer(embedded_seq)
